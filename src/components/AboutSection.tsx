...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section 
      id="about" 
      className="relative w-screen min-h-screen bg-black text-[#E8DFD8] font-sans py-24 lg:py-32 px-6 sm:px-12 lg:px-20 overflow-hidden flex items-center"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="relative mb-6 select-none">
              <h2
                className="text-5xl sm:text-6xl md:text-7xl lg:text-[5.4rem] tracking-tight uppercase leading-[0.88] font-bebas"
              >
            ...
            >
              ...
              <div className="flex flex-col">
                <span 
                  className="text-3xl sm:text-4xl font-light text-[#F4EBE2] tracking-tight font-bebas"
                >
                  12+
                </span>
              ...
              <div className="flex flex-col">
                <span 
                  className="text-3xl sm:text-4xl font-light text-[#D4AF37] tracking-tight font-bebas"
                >
                  CA
                </span>
                <span className="text-[10px] font-medium tracking-[0.22em] uppercase text-[#A8988B] mt-0.5">
            ...
            {/* Download Resume Button for About Section */}
            ...
            >
              ...
              <div className="relative overflow-hidden w-full max-w-[390px] aspect-[4/5] min-h-[487px] bg-black rounded-sm">
                ...
                <div className="absolute bottom-4 right-4 z-20 select-none">
                  <span 
                    className="text-4xl text-[#F2D8A7] drop-shadow-[0_0_12px_rgba(242,216,167,0.5)] transition-colors duration-300 group-hover:text-white font-allura tracking-wide"
                  >
                    Osama
                  </span>
                </div>
